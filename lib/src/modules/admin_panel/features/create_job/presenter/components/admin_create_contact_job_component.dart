...
class AdminCreateContactjobComponent extends StatefulWidget {
  ...
  const AdminCreateContactjobComponent({
    Key? key,
  ...
  @override
  State<AdminCreateContactjobComponent> createState() =>
      _AdminCreateContactjobComponentState();
}

class _AdminCreateContactjobComponentState
    extends State<AdminCreateContactjobComponent> {
