...
class AdminCreateDataJobComponent extends StatefulWidget {
  ...
  const AdminCreateDataJobComponent({
    Key? key,
  ...
  @override
  State<AdminCreateDataJobComponent> createState() =>
      _AdminCreateDataJobComponentState();
}

class _AdminCreateDataJobComponentState
    extends State<AdminCreateDataJobComponent> {
